...
/******/return __webpack_require__(0);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){var pageloader=__webpack_require__(1);var appsettingsobject=__webpack_require__(16);var $=__webpack_require__(5);$(function(){var appsettings=appsettingsobject.config;appsettings.userinfo.userid=$('.kk_aj_userid').html();var currentpage=$('.kk_aj_CurrentPageType').html();//$("#mainapp").attr('style','background:#fff;')
//  .html("funkar!");
var init=function init(){pageloader.pagerequest(currentpage);};init();});/***/},/* 1 *//***/function(module,exports,__webpack_require__){var startpage=__webpack_require__(2);var booklistpage=__webpack_require__(7);var skrivbokenpage=__webpack_require__(9);var boktipspage=__webpack_require__(10);var scoreboardpage=__webpack_require__(11);var bibblomonpage=__webpack_require__(12);var inventorypage=__webpack_require__(13);var shoppage=__webpack_require__(14);var installningarpage=__webpack_require__(15);var appsettings=__webpack_require__(16);var $=__webpack_require__(5);module.exports={pagerequest:function pagerequest(page){var loadpage=function loadpage(tmppage){var requestpage={'bb_aj_Start_Krypin':function bb_aj_Start_Krypin(){startpage.init();console.log("logga detta "+appsettings.config.globalconfig.dnnURL);return false;},'bb_aj_Boklistor_Krypin':function bb_aj_Boklistor_Krypin(){booklistpage.init();return false;},'bb_aj_Skrivboken_Krypin':function bb_aj_Skrivboken_Krypin(){skrivbokenpage.init();return false;},'bb_aj_Boktips_Krypin':function bb_aj_Boktips_Krypin(){boktipspage.init();return false;},'bb_aj_Scoreboard_Krypin':function bb_aj_Scoreboard_Krypin(){scoreboardpage.init();return false;},'bb_aj_Bibblomon_Krypin':function bb_aj_Bibblomon_Krypin(){bibblomonpage.init();return false;},'bb_aj_Inventarie_Krypin':function bb_aj_Inventarie_Krypin(){inventorypage.init();return false;},'bb_aj_shop_Krypin':function bb_aj_shop_Krypin(){shoppage.init();return false;},'bb_aj_setup_krypin':function bb_aj_setup_krypin(){installningarpage.init();return false;},'default':function _default(){startpage.init();return false;}};return(requestpage[tmppage]||requestpage['default'])();};loadpage(page);}/***/};},/* 2 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);module.exports={init:function init(value){var moduleName='Start';bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 3 *//***/function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(global,module,_){/**
	 * @license
...
if(!noGlobal){window.jQuery=window.$=jQuery;}return jQuery;});/***/},/* 6 *//***/function(module,exports,__webpack_require__){var $=__webpack_require__(5);// sköter globala settings och sidövergripande händelser och inställningar dynamiskt satta on runtime. måste skicka med modulens namn (moduletypID) tex Booklist, Skrivbok, bibblomon m.m
module.exports={init:function init(moduletypID){this.cacheDom(moduletypID);this.BindEvent();this.Settings();},cacheDom:function cacheDom(modtypID){this.$cmdMenyOpen=$('.kk_bb_open'+modtypID);},BindEvent:function BindEvent(){},Settings:function Settings(){this.$cmdMenyOpen.addClass('bb_aj_valdmeny');}/***/};},/* 7 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);var bb_containerbehaviors=__webpack_require__(8);module.exports={init:function init(value){var moduleName='Booklist';bb_containerbehaviors.init(moduleName);bb_pagebehaviors.init(moduleName);//$('.kk_bb_openBooklists').addClass('bb_aj_valdmeny');
////lodash.init();
...
/////////////////////////////////////////////////////
//test();
}};var users=[{'user':'barney','age':36,'active':true},{'user':'fred','age':40,'active':false},{'user':'pebbles','age':1,'active':true}];var test=function test(){var namn=$('.kk_aj_CurrentPageType').html();var t=_.find(users,function(o){return o.age==40;});};//var bb_containerbehaviors = {
...
//};
//})
/***/},/* 8 *//***/function(module,exports,__webpack_require__){var $=__webpack_require__(5);// sköter slidning och öppning av settingsblocken. måste skicka med modulens namn (moduletypID) tex Booklist, Skrivbok, bibblomon m.m.
module.exports={init:function init(moduletypID){this.cacheDom(moduletypID);this.bindEvent();this.render();},cacheDom:function cacheDom(modtypid){this.$bb_aj_cmdAdd=$('#bb_aj_cmdAdd_'+modtypid);this.$bb_aj_cmdSetting=$('#bb_aj_cmdSetting_'+modtypid);this.$bb_aj_Container=$('.bb_aj_Container');this.$bb_aj_AddContainer=$('.bb_aj_AddContainer_'+modtypid);this.$bb_aj_SettingsContainer=$('.bb_aj_SettingsContainer_'+modtypid);this.$bb_aj_cmdClose=$('.bb_aj_CloseContainer');},bindEvent:function bindEvent(){this.$bb_aj_cmdAdd.on('click',this.addboxbehavior.bind(this));this.$bb_aj_cmdSetting.on('click',this.settingsboxbehavior.bind(this));this.$bb_aj_cmdClose.on('click',this.closeboxbehavior.bind(this));},render:function render(){this.$bb_aj_Container.hide();},addboxbehavior:function addboxbehavior(){this.$bb_aj_AddContainer.slideToggle(500);if(this.$bb_aj_SettingsContainer.is(':visible')){this.$bb_aj_SettingsContainer.hide(500);};},settingsboxbehavior:function settingsboxbehavior(){this.$bb_aj_SettingsContainer.slideToggle(500);if(this.$bb_aj_AddContainer.is(':visible')){this.$bb_aj_AddContainer.hide(500);};},closeboxbehavior:function closeboxbehavior(){this.$bb_aj_Container.hide(500);}};/***/},/* 9 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);var bb_containerbehaviors=__webpack_require__(8);module.exports={init:function init(value){var moduleName='Skrivbok';bb_containerbehaviors.init(moduleName);bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 10 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(_){_=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);var bb_containerbehaviors=__webpack_require__(8);module.exports={init:function init(value){var moduleName='Boktips';bb_containerbehaviors.init(moduleName);bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(3));/***/},/* 11 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);module.exports={init:function init(value){var moduleName='Scoreboard';bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 12 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);module.exports={init:function init(value){var moduleName='Bibblomon';bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 13 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);module.exports={init:function init(value){var moduleName='Inventory';bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 14 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);module.exports={init:function init(value){var moduleName='Shop';bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 15 *//***/function(module,exports,__webpack_require__){var _=__webpack_require__(3);var $=__webpack_require__(5);var bb_pagebehaviors=__webpack_require__(6);module.exports={init:function init(value){var moduleName='Setup';bb_pagebehaviors.init(moduleName);/////////////////////////////////////////////////////
}};/***/},/* 16 *//***/function(module,exports){module.exports={config:{globalconfig:{apiserver:"",dnnURL:"http://localdev.kivdev.se",localOrServerURL:"",htmltemplateURL:"http://localdev.kivdev.se/Portals/_default/Skins/bb_DAGOBAH_krypin/htmltemplates"},userinfo:{userid:"",rollid:"",skin:""},currentpage:"",debug:"false"// true / false
}/***/};}]/******/);