   ...
   <div id="aj_bb_KrypinSkin"  class="wrapper row3 aj_bb_KrypinSkin" >
        ...
        <div class="aj_bb_KrypinMainGrid Grid--gutters Grid--1of12">
            ...
            <div class="Grid-cell">
                <div class="container">
                    <div class="row ">
                        <div id="top_full_Pane" class="col top_full_Pane" runat="server"></div>                        
                    </div>
                </div>
                <div class="container">
                    <div class="row ">
                ...
                <div class="container">
                    <div class="row">
                       <div id="three_one_two_Pane" class="col-6 three_one_two_Pane" runat="server"></div>
                       <div id="three_two_two_Pane" class="col-6 three_two_two_Pane" runat="server"></div>
                    </div>
                </div>
...
<dnn:DnnJsInclude runat="server" FilePath="public/js/aj_bb_Krypinbundle.4.2.1.js" PathNameAlias="SkinPath" />
